...
class CallbackPolicy
{
    ...
    {
        return $user->hasPermissionTo('callbacks.read');
    }
    ...
    {
        return $user->hasPermissionTo('callbacks.write');
    }
    ...
    {
        return $user->hasPermissionTo('callbacks.delete');
    }
     ...
     * @return mixed
     */
    public function restore(User $user, Callback $callback)
    {
        //
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Callback $callback)
    {
        //
    }
}
