...
class EventTypeGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('web_color', trans('partymeister-core::backend/event_types.web_color'))->renderer(BladeRenderer::class, ['template' => 'partymeister-core::grid.color']);
        $this->addColumn('slide_color', trans('partymeister-core::backend/event_types.slide_color'))->renderer(BladeRenderer::class, ['template' => 'partymeister-core::grid.color']);
