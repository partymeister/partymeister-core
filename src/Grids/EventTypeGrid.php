...
class EventTypeGrid extends Grid
{
    protected function setup()
    {
        ...
        $this->addEditAction(trans('motor-admin::backend/global.edit'), 'backend.event_types.edit');
        $this->addDeleteAction(trans('motor-admin::backend/global.delete'), 'backend.event_types.destroy');
    }
}
