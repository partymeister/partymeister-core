...
class CallbackGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('destination', trans('partymeister-core::backend/callbacks.destination'), true)->renderer(TranslateRenderer::class, ['file' => 'partymeister-core::backend/callbacks.destinations']);
        $this->addColumn('embargo_until', trans('partymeister-core::backend/callbacks.embargo_until'), true)->renderer(DateRenderer::class);
