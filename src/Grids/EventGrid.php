...
class EventGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('sort_position', trans('partymeister-core::backend/events.sort_position'),
            true)->renderer(BladeRenderer::class,
            [ 'template' => 'partymeister-core::grid.input_callback', 'field' => 'sort_position' ]);

        $this->addColumn('is_visible', trans('partymeister-core::backend/events.is_visible'), true)->renderer(BooleanRenderer::class);
        $this->addColumn('is_organizer_only', trans('partymeister-core::backend/events.is_organizer_only'), true)->renderer(BooleanRenderer::class);
