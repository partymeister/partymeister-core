...
class VisitorWebsiteRegistrationForm extends Form
{
    public function buildForm()
    {
        $this
            ...
            ->add('country_iso_3166_1', 'select', ['label' => trans('motor-backend::backend/global.address.country'), 'default_value' => (isset($_SERVER['GEOIP_COUNTRY_CODE']) ? $_SERVER['GEOIP_COUNTRY_CODE'] : 'DE'), 'choices' => Countries::getNames()])
