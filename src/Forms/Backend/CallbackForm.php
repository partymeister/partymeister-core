...
class CallbackForm extends Form
{
    ...
    public function buildForm()
    {
        $this->add('name', 'text', [ 'label' => trans('motor-backend::backend/global.name'), 'rules' => 'required' ])
             ...
             ->add('title', 'text',
                 [ 'label' => trans('partymeister-core::backend/callbacks.title'), 'rules' => 'required' ])
             ...
             ->add('embargo_until', 'datetimepicker',
                 [ 'label' => trans('partymeister-core::backend/callbacks.embargo_until') ])
